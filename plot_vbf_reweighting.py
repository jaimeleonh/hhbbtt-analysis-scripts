...
f_true = "/eos/user/j/jleonhol/cmt/FeaturePlotLLR/llr_2018/cat_baseline/prod_2202/root/HHKinFit_mass__pg_vbf__nodata.root"
f_rew = "/eos/user/j/jleonhol/cmt/VBFFeaturePlotLLR/llr_2018/cat_baseline/prod_2202/root/HHKinFit_mass__pg_vbf__nodata.root"
...
for i, (f, leg, color) in enumerate(zip([f_true, f_rew], legends, colors)):
    ...
    histos.append(copy(tf.Get("histograms/vbf_0p5_1_1")))
...
c.SaveAs("vbf_0p5_1_1.pdf")
c.SaveAs("vbf_0p5_1_1.png")
